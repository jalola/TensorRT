...
from Llama.frameworks import GPT2HuggingFace
from NNDF.general_utils import NNFolderWorkspace
from Llama.GPT2ModelConfig import GPT2ModelTRTConfig, GPT2BenchmarkingArgs, GPT2TRTBenchmarkingArgs
from Llama.measurements import gpt2_inference, full_inference, calculate_perplexity
from Llama.export import GPT2ONNXFile, GPT2TRTEngine
...
class GPT2TRTDecoder(TRTHFRunner):
    def __init__(
        ...
        self.generation_config = GenerationConfig.from_model_config(hf_config) if self.can_generate() else None
        ...
        self.embedding_size_per_head = self.config.hidden_size // self.num_heads
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        output["transformers_version"] = "1.0.0"
...
#             embedding_size_per_head = hf_config.hidden_size // num_heads
